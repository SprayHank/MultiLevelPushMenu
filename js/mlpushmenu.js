...
(function(window) {
	...
	function mlPushMenu(el, trigger, options) {
		...
		(this.support = Modernizr.csstransforms) && this._init();
	};
	mlPushMenu.prototype = {
		...
		_initCSS: function() {
			...
			/* overlap */
			CSS += ".mp-overlap .mp-level.mp-level-open { box-shadow : 1px 0 0 rgba(0, 0, 0, 0.2); " + preFix("transform", "translateX(-40px)") + " }";
			/* First level */
